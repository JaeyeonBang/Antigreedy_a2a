...
```
직관: 공정몫 이하면 셋 다 full. 과점할수록 quadratic 캡이 *제곱으로* 줄어든다(o=1→½, o=2→1/5, o=3→1/10). Weyl-2017이 "2차여야 robust"라 했으니 핵심 가설은 **quadratic이 linear/flat보다 공정성-welfare 프런티어를 개선**하는가.
